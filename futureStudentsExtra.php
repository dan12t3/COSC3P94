...
<div class="container-fluid">
    <div class="row">
    <img src="images/extra.jpg" width="100%"/>
    </div>
...
<div class="customContainer">
    <div class="row mainBody">
        <div class="col-lg-9 content">
            <h1>Extracurriculars and Student Experience</h1>
            ...
            <p class="tourBody">Brock’s Student Services help support and promote the present and future well-being of students, while providing an exceptional student experience both inside and outside the classroom.
            <br>
                <br>
